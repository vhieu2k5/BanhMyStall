...
public class PauseMenu : MonoBehaviour
{
    ...
    //    pausebg.transform.DOMoveY(0 + Camera.main.transform.position.y, 0.5f);
        ...
        continuebutton.transform.position = new Vector3(0, -60 + Camera.main.transform.position.y, 1);
    ...
    public void Continue()
    {
        ...
        Time.timeScale = 1;
        continuebutton.transform.DOMove(new Vector3(0, -60 + Camera.main.transform.position.y, 1), 0.5f);
        pausebox.transform.position = new Vector3(0, 60 + Camera.main.transform.position.y, 1);
